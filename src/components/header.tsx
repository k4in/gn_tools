              ...
              return (
                <div key={name} className="flex items-stretch gap-4">
                  ...
                  <div className="flex min-w-28 flex-col justify-center gap-0.5">
                    <span className="text-[10px] font-medium tracking-wider text-muted-foreground uppercase">{name}</span>
                    {finishTick !== undefined ? (
                      <>
                        <span className="text-sm font-medium tabular-nums">
                          Tick {finishTick}
                          <span className="ml-1.5 font-normal text-muted-foreground">{clockLabel(startCfg, finishTick)}</span>
                        </span>
